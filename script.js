...
qcmData.santé = {
  débutant: [
    {
      question: "Quel document permet de désigner une personne de confiance ?",
      options: ["Carte vitale", "Mandat de protection future", "Formulaire de consentement", "Directive anticipée"],
      answer: 2
    },
    {
      question: "Quel professionnel est habilité à établir un certificat médical circonstancié ?",
      options: ["Médecin", "Infirmier", "Psychologue", "MJPM"],
      answer: 0
    },
    {
      question: "Quel organisme gère la Complémentaire Santé Solidaire ?",
      options: ["CAF", "MDPH", "CPAM", "ARS"],
      answer: 2
    },
    {
      question: "Quel droit fondamental est lié au consentement aux soins ?",
      options: ["Droit à l’éducation", "Droit à la santé", "Droit à l’autonomie", "Droit à la mobilité"],
      answer: 2
    },
    {
      question: "Quel document est requis pour une hospitalisation sans consentement ?",
      options: ["Ordonnance", "Certificat médical", "Décision du juge", "Lettre du MJPM"],
      answer: 1
    },
    {
      question: "Quel professionnel peut accompagner le majeur dans ses démarches de santé ?",
      options: ["MJPM", "Avocat", "Notaire", "Psychologue"],
      answer: 0
    },
    {
      question: "Quel organisme attribue l’AAH ?",
      options: ["CAF", "MDPH", "CPAM", "ARS"],
      answer: 1
    },
    {
      question: "Quel document est utilisé pour évaluer l’autonomie d’une personne âgée ?",
      options: ["Grille AGGIR", "Grille CNIL", "Grille RGPD", "Grille APA"],
      answer: 0
    },
    {
      question: "Quel professionnel peut rédiger un projet de soins ?",
      options: ["MJPM", "Médecin", "Avocat", "Infirmier"],
      answer: 1
    },
    {
...
qcmData.santé.intermédiaire = [
  {
    question: "Quel recours peut être engagé si un établissement refuse l’accès au dossier médical d’un majeur protégé ?",
    options: ["Saisine du juge des tutelles", "Demande à la CPAM", "Saisine de la CNIL", "Plainte à l’ARS"],
    answer: 2
  },
  {
    question: "Quel document est requis pour une demande d’hospitalisation sous contrainte en soins psychiatriques ?",
    options: ["Certificat médical circonstancié", "Ordonnance du juge", "Lettre du MJPM", "Relevé bancaire"],
    answer: 0
  },
  {
    question: "Quel professionnel peut intervenir dans une équipe mobile de soins palliatifs ?",
  ...
  {
    question: "Quel document est utilisé pour évaluer les besoins en soins d’un majeur protégé ?",
  ...
  {
    question: "Quel document permet de suivre les traitements médicaux du majeur protégé ?",
...
qcmData.santé.expérimenté = [
  ...
  {
    question: "Quel professionnel peut accompagner le majeur dans une procédure de soins sous contrainte ?",
    options: ["MJPM", "Avocat", "Médecin", "Psychologue"],
    answer: 0
  },
  {
    question: "Quel document est requis pour une demande de soins psychiatriques à la demande d’un tiers ?",
    options: ["Deux certificats médicaux", "Lettre du MJPM", "Relevé bancaire", "Carte vitale"],
    answer: 0
  },
  {
    question: "Quel organisme peut être saisi en cas de non-respect des droits du patient en établissement ?",
    options: ["ARS", "MDPH", "CPAM", "Conseil départemental"],
    answer: 0
  }
];
